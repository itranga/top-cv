...
export default function Layout({
  ...
  return (
    ...
    <nav className="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <a className="navbar-brand logo-image color" href="index-2.html"><img src="images/logo-color.svg" alt="alternative"></a>
        <a className="navbar-brand logo-image white" href="index-2.html"><img src="images/logo-white.svg" alt="alternative"></a> 
            ...
            <ul className="navbar-nav ml-auto">
                ...
                <li className="nav-item dropdown">
                    ...
                    <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a className="dropdown-item" href="project-details.html"><span className="item-text">PROJECT DETAILS</span></a>
