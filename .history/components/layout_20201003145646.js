                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="text-container">
                            ...
                            <p className="p-large">Use Juno business landing page to create an efficient and memorable online presence for your startup company</p>
                            <a className="btn-outline-lg page-scroll" href="#services">DISCOVER</a>
                        </div>
                    </div> 
                    <div className="col-lg-6">
                        ...
                        <div className="form-container">
                            <form id="getQuoteForm" data-toggle="validator" data-focus="false">
                                <div className="form-group">
                                    <input type="text" className="form-control-input" id="gname" name="gname" required />
                                    <label className="label-control" for="gname">Name</label>
                                    <div className="help-block with-errors"></div>
                                </div>
                                <div className="form-group">
                                    <input type="email" className="form-control-input" id="gemail" name="gemail" required />
                                    <label className="label-control" for="gemail">Email</label>
                                    <div className="help-block with-errors"></div>
                                </div>
                                <div className="form-group">
                                    <input type="text" className="form-control-input" id="gphone" name="gphone" required />
                                    <label className="label-control" for="gphone">Phone</label>
                                    <div className="help-block with-errors"></div>
                                </div>
                                <div className="form-group">
                                    <select className="form-control-select" id="gselect" required>
                                        <option className="select-option" value="" disabled selected>Select Package</option>
                                ...
                                <div className="form-group checkbox">
                                    <input type="checkbox" id="gterms" value="Agreed-to-Terms" name="gterms" required />I agree to Juno's <a href="privacy-policy.html">Privacy Policy</a> and <a href="terms-conditions.html">Terms & Conditions</a>
                                    <div className="help-block with-errors"></div>
                                </div>
                                <div className="form-group">
                                    <button type="submit" className="form-control-submit-button">GET QUOTE</button>
                                </div>
                                <div className="form-message">
                                    <div id="gmsgSubmit" className="h3 text-center hidden"></div>
                                </div>
                            </form>
