...
const initialState = {
  gname: "ranga",
  gemail: "itranga@gmail.com",
  gphone: "231323",
  gselect: "Information Technology",
  gdocpicker: "",
};
                    ...
                    >
                      <div className="form-group">
                        <input
                          ...
                          name="gname"
                          onChange={(event) =>
                            setInput("gname", event.target.value)
                          }
                          value={formState.gname}
                          required
                        />
                      ...
                      <div className="form-group">
                        <input
                          ...
                          name="gemail"
                          onChange={(event) =>
                            setInput("gemail", event.target.value)
                          }
                          value={formState.gemail}
                          required
                        />
                      ...
                      <div className="form-group">
                        <input
                          ...
                          name="gphone"
                          onChange={(event) =>
                            setInput("gphone", event.target.value)
                          }
                          value={formState.gphone}
                          required
                        />
                      ...
                      <div className="form-group">
                        <select
                          ...
                          id="gselect"
                          onChange={(event) =>
                            setInput("gselect", event.target.value)
                          }
                          defaultValue={formState.gselect}
                          required
                        >
                      ...
                      <div className="form-group">
                        <input
                          ...
                          name="gdocpicker"
                          onChange={(event) =>
                            setInput("gdocpicker", event.target.value)
                          }
                          value={formState.gdocpicker}
